...
//costruttore con parametro LinearContainer
template<typename Data>
...
Vector<Data>::Vector(const Vector<Data>& vec){
  ...
  std::copy(vec.Elements, vec.Elements + vec.size, Elements);  //questa funzione prende in input un puntatore all'array origine del dato, il puntatore al termine di quell'array che voglio copare e la destinazione
  size = vec.size;
  }
